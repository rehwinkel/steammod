...
public class YellowstoneBiome extends Biome {
    ...
    public YellowstoneBiome() {
        super((new Biome.Builder()).surfaceBuilder(WorldRegistry.YELLOWSTONE_SURFACE, SurfaceBuilder.AIR_CONFIG).precipitation(RainType.RAIN).category(Category.EXTREME_HILLS).depth(0.2F).scale(0.2F).temperature(25F).downfall(8F).func_235097_a_((new BiomeAmbience.Builder()).func_235246_b_(0xff0000ff).func_235248_c_(0xffff0000).func_235239_a_(0xffff00ff).func_235243_a_(MoodSoundAmbience.field_235027_b_).func_235238_a_()).parent(null)
