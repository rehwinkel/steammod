...
public class WorldGen {
    ...
    public static void addYellowstoneLakes(Biome b) {
        b.addFeature(GenerationStage.Decoration.LAKES, FeatureRegistry.LAKE.get().withConfiguration(new YellowstoneLakeConfig(10)).withPlacement(Placement.WATER_LAKE.configure(new ChanceConfig(10))));
    }
