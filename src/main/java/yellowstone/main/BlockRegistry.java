...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> DIRT = BLOCKS.register("dirt", () -> new DirtBlock(
    ...
    public static final RegistryObject<Block> DOUGLAS_SAPLING = BLOCKS.register("douglas_sapling",
            () -> new SaplingBlock(new DouglasTree(),
    ...
    public static final RegistryObject<Block> COPPER_ORE = BLOCKS.register("copper_ore", () -> new OreBlock(
            AbstractBlock.Properties.create(Material.ROCK).setRequiresTool().hardnessAndResistance(3.0F, 3.0F)));
    ...
    public static final RegistryObject<Block> BRASS_BLOCK = BLOCKS.register("brass_block", () -> new Block(
            AbstractBlock.Properties.create(Material.IRON, MaterialColor.GOLD).setRequiresTool()
    ...
    public static final RegistryObject<Block> COPPER_BLOCK = BLOCKS.register("copper_block", () -> new Block(
            AbstractBlock.Properties.create(Material.IRON, MaterialColor.GOLD).setRequiresTool()
                    .hardnessAndResistance(3.0F, 6.0F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> NICKEL_BLOCK = BLOCKS.register("nickel_block", () -> new Block(
            AbstractBlock.Properties.create(Material.IRON, MaterialColor.GOLD).setRequiresTool()
                    .hardnessAndResistance(3.0F, 6.0F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> GRASS = BLOCKS.register("grass", () -> new yellowstone.block.GrassBlock(
            AbstractBlock.Properties.create(Material.ORGANIC).tickRandomly().hardnessAndResistance(0.6F)
                    .sound(SoundType.PLANT)));
    public static final RegistryObject<Block> PATH = BLOCKS.register("path", () -> new PathBlock(
            AbstractBlock.Properties.create(Material.ORGANIC).hardnessAndResistance(0.65F).sound(SoundType.PLANT)));
    public static final RegistryObject<Block> LAVASTONE_SLAB = BLOCKS
            .register("lavastone_slab", () -> new SlabBlock(AbstractBlock.Properties.from(LAVASTONE.get())));
    public static final RegistryObject<Block> LAVASTONE_WALL = BLOCKS
            .register("lavastone_wall", () -> new WallBlock(AbstractBlock.Properties.from(LAVASTONE.get())));
    public static final RegistryObject<Block> LAVASTONE_STAIRS = BLOCKS.register("lavastone_stairs",
            () -> new StairsBlock(() -> LAVASTONE.get().getDefaultState(),
                    AbstractBlock.Properties.from(LAVASTONE.get())));
    public static final RegistryObject<Block> POLISHED_LAVASTONE = BLOCKS
            .register("polished_lavastone", () -> new Block(AbstractBlock.Properties.from(LAVASTONE.get())));
    public static final RegistryObject<Block> POLISHED_LAVASTONE_SLAB = BLOCKS
            .register("polished_lavastone_slab", () -> new SlabBlock(AbstractBlock.Properties.from(LAVASTONE.get())));
    public static final RegistryObject<Block> POLISHED_LAVASTONE_STAIRS = BLOCKS.register("polished_lavastone_stairs",
            () -> new StairsBlock(() -> POLISHED_LAVASTONE.get().getDefaultState(),
                    AbstractBlock.Properties.from(LAVASTONE.get())));
    public static final RegistryObject<Block> GOOSEBERRY_BUSH = BLOCKS.register("gooseberry_bush",
            () -> new GooseberryBushBlock(
                    AbstractBlock.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement()
                            .sound(SoundType.SWEET_BERRY_BUSH)));
    public static final RegistryObject<Block> SMELTERY = BLOCKS.register("smeltery", () -> new SmelteryBlock(
            AbstractBlock.Properties.create(Material.ROCK, MaterialColor.STONE).hardnessAndResistance(1.5F, 6.0F)
                    .sound(SoundType.STONE)));
    public static final RegistryObject<Block> STEAM_PIPE = BLOCKS.register("steam_pipe", () -> new SteamPipeBlock(
            AbstractBlock.Properties.create(Material.IRON, MaterialColor.GOLD).harvestLevel(0)
                    .harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> PHLOX = BLOCKS.register("phlox",
            () -> new FlowerBlock(Effects.FIRE_RESISTANCE, 10,
    ...
    public static final RegistryObject<Block> POTTED_DOUGLAS_SAPLING = BLOCKS.register("potted_douglas_sapling", () -> {
        FlowerPotBlock block = new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, DOUGLAS_SAPLING,
                AbstractBlock.Properties.create(Material.MISCELLANEOUS).zeroHardnessAndResistance().notSolid());
        ((FlowerPotBlock) Blocks.FLOWER_POT)
                .addPlant(new ResourceLocation(Yellowstone.MODID, "douglas_sapling"), () -> block);
        return block;
    });
    public static final RegistryObject<Block> POTTED_PHLOX = BLOCKS.register("potted_phlox", () -> {
        FlowerPotBlock block = new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, PHLOX,
                AbstractBlock.Properties.create(Material.MISCELLANEOUS).zeroHardnessAndResistance().notSolid());
    ...
    static {
        ...
        ITEMS.register("copper_block",
                () -> new BlockItem(COPPER_BLOCK.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("nickel_block",
                () -> new BlockItem(NICKEL_BLOCK.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("grass", () -> new BlockItem(GRASS.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("lavastone_slab",
                () -> new BlockItem(LAVASTONE_SLAB.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("lavastone_stairs",
                () -> new BlockItem(LAVASTONE_STAIRS.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("lavastone_wall",
                () -> new BlockItem(LAVASTONE_WALL.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("polished_lavastone",
                () -> new BlockItem(POLISHED_LAVASTONE.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("polished_lavastone_slab",
                () -> new BlockItem(POLISHED_LAVASTONE_SLAB.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("polished_lavastone_stairs", () -> new BlockItem(POLISHED_LAVASTONE_STAIRS.get(),
                new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("path", () -> new BlockItem(PATH.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("smeltery",
                () -> new BlockItem(SMELTERY.get(), new Item.Properties().group(Yellowstone.y_blocks)));
        ITEMS.register("steam_pipe",
                () -> new BlockItem(STEAM_PIPE.get(), new Item.Properties().group(Yellowstone.y_blocks)));
